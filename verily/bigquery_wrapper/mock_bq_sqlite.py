...
Sample usage:
    ...
    client = mock_bq_sqlite.Client(project_id)
...
# different delimiter. It's pretty strict about what special characters they
...
class Client(MockBaseClient):
    """Stores pointers to a mock BigQuery project, backed by an in-memory sqlite database instead.
    ...
    def _create_table(self, standardized_path, schema_fields=None, schema_string=None):
        ...
        """
        self._add_table(standardized_path)
